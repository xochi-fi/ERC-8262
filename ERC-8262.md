...
| **Timestamp freshness**  | 0x01, 0x04, 0x05, 0x06, 0x07, 0x09             | The proof timestamp MUST NOT be in the future and MUST be within an implementation-defined maximum age (reference: 1 hour). Types without a timestamp input are exempt.              |
